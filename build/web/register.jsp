<%-- 
    Document   : register
    Created on : May 6, 2023, 10:08:10 AM
    Author     : Acer
--%>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form class="mx-1 mx-md-4" action="RegisterServlet" method="post">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" name="role" id="form3Example4cd" class="form-control" />
                                          ...
                                          <p class="small fw-bold mt-2 pt-1 mb-0">You have Account <a href="LoginServlet"
